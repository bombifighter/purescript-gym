...
setMTId s (MembershipType mt) = MembershipType {id:mt.id, name:mt.name, isPass:mt.isPass, occasions: mt.occasions, fullPrice: mt.fullPrice, studentPrice:mt.studentPrice, clubPrice:mt.clubPrice}
